...
export const projects: Project[] = [
  {
    ...
    description: "Ein interaktiver 3D-Konfigurator für den Jordan 1. Nutzer können Schuhe individuell in Echtzeit einfärben, vorgefertigte Designs kaufen oder Designer beauftragen.",
    descriptionEn: "An interactive 3D configurator for the Jordan 1. Users can customize shoes in real-time, buy pre-made designs, or commission designers.",
    ...
    roleEn: "Lead Developer & Designer",
    duration: "4 Monate",
    ...
    sections: [
      {
        heading: "Überblick",
        content: "Dieses Projekt entstand aus der Idee, den klassischen Nike Jordan 1 vollständig im Browser erlebbar zu machen. Ziel war es, eine Web-Plattform zu schaffen, auf der Nutzer einen Schuh in 3D betrachten, individuell einfärben und direkt kaufen können.",
        images: ["/Project Pics/solemate_webapp/HomePage.png"],
      },
      {
        heading: "Technische Umsetzung",
        content: "Mit Three.js wurde ein performantes 3D-Modell integriert, das Echtzeit-Farbwechsel per Raycast-Picking ermöglicht. Jede einzelne Schuhkomponente (Sohle, Schnürsenkel, Panels) kann individuell eingefärbt werden. Die Rendering-Pipeline nutzt PBR-Materialien für realistische Darstellung.",
        images: ["/Project Pics/solemate_webapp/anpassenPage.png"],
      },
      {
        heading: "Shop & E-Commerce Flow",
        content: "Ein eingebetteter Shop-Flow erlaubt es Nutzern, fertige Konfigurationen direkt zu kaufen oder einen Designer zu beauftragen. Dazu gehören Produktlisten mit Filterung, Detailansichten, ein Warenkorb-System und Benutzerprofile mit Authentifizierung.",
        images: ["/Project Pics/solemate_webapp/shopPage.png", "/Project Pics/solemate_webapp/shopDetailPage.png"],
      },
      {
        heading: "Design & UX",
        content: "Das UI wurde modern und minimalistisch gestaltet mit klaren Kontrasten und einem durchgängigen Design-System. Besonderer Wert wurde auf die mobile Nutzbarkeit und die Performance der 3D-Ansicht gelegt.",
        images: ["/Project Pics/solemate_webapp/kontaktPage.png", "/Project Pics/solemate_webapp/ProfilePage.png"],
      },
    ],
    sectionsEn: [
      { heading: "Overview", content: "This project was born from the idea of making the classic Nike Jordan 1 fully experienceable in the browser. The goal was to create a web platform where users can view a shoe in 3D, customize colors, and buy directly.", images: ["/Project Pics/solemate_webapp/HomePage.png"] },
      { heading: "Technical Implementation", content: "Three.js was used to integrate a performant 3D model enabling real-time color changes via raycast picking. Each shoe component (sole, laces, panels) can be individually colored. The rendering pipeline uses PBR materials for realistic display.", images: ["/Project Pics/solemate_webapp/anpassenPage.png"] },
      { heading: "Shop & E-Commerce Flow", content: "An embedded shop flow allows users to buy finished configurations directly or commission a designer. This includes product listings with filtering, detail views, a shopping cart system, and user profiles with authentication.", images: ["/Project Pics/solemate_webapp/shopPage.png", "/Project Pics/solemate_webapp/shopDetailPage.png"] },
      { heading: "Design & UX", content: "The UI was designed modern and minimalist with clear contrasts and a consistent design system. Special focus was placed on mobile usability and 3D view performance.", images: ["/Project Pics/solemate_webapp/kontaktPage.png", "/Project Pics/solemate_webapp/ProfilePage.png"] },
    ],
  },
  {
    slug: "randolingo",
  ...
  },
  {
    ...
    images: ["/Project Pics/Solemate/Homepage.png", "/Project Pics/Solemate/Shop.png", "/Project Pics/Solemate/DetailShoe.png", "/Project Pics/Solemate/CustomShoePic.png", "/Project Pics/Solemate/Cart.png", "/Project Pics/Solemate/Login.png", "/Project Pics/Solemate/Register.png", "/Project Pics/Solemate/Contact.png"],
    ...
    contextEn: "University Project",
    sections: [
      { heading: "Überblick", content: "Eine native iOS App entwickelt mit Swift für den Kauf und die Individualisierung von Sneakern. Die App verbindet E-Commerce mit 3D-Produktkonfiguration.", images: ["/Project Pics/Solemate/Homepage.png"] },
      { heading: "Shop & Produkte", content: "Vollständiger Shop mit Produktkatalog, Detailansichten der Schuhe mit 360°-Ansicht, Größenauswahl und Warenkorb-Funktionalität. Benutzer können zwischen verschiedenen Modellen und Farben wählen.", images: ["/Project Pics/Solemate/Shop.png", "/Project Pics/Solemate/DetailShoe.png"] },
      { heading: "3D-Konfiguration", content: "Die Kern-Feature der App: Nutzer können Schuhe in einer interaktiven 3D-Ansicht individuell anpassen. Verschiedene Teile des Schuhs können einzeln eingefärbt und kombiniert werden.", images: ["/Project Pics/Solemate/CustomShoePic.png", "/Project Pics/Solemate/Cart.png"] },
      { heading: "Benutzerverwaltung", content: "Vollständiges Auth-System mit Login, Registrierung und Passwort-Recovery. Benutzerprofile speichern Konfigurationen und Bestellhistorie.", images: ["/Project Pics/Solemate/Login.png", "/Project Pics/Solemate/Register.png"] },
    ],
    sectionsEn: [
      { heading: "Overview", content: "A native iOS app built with Swift for purchasing and customizing sneakers. The app combines e-commerce with 3D product configuration.", images: ["/Project Pics/Solemate/Homepage.png"] },
      { heading: "Shop & Products", content: "Complete shop with product catalog, shoe detail views with 360° view, size selection, and cart functionality. Users can choose between different models and colors.", images: ["/Project Pics/Solemate/Shop.png", "/Project Pics/Solemate/DetailShoe.png"] },
      { heading: "3D Configuration", content: "The core feature: users can customize shoes in an interactive 3D view. Different parts of the shoe can be individually colored and combined.", images: ["/Project Pics/Solemate/CustomShoePic.png", "/Project Pics/Solemate/Cart.png"] },
      { heading: "User Management", content: "Complete auth system with login, registration, and password recovery. User profiles store configurations and order history.", images: ["/Project Pics/Solemate/Login.png", "/Project Pics/Solemate/Register.png"] },
    ],
  },
];